[![Download the latest release](docs/img/download-button.png)](https://codeberg.org/peter88213/timeline-view-tk/raw/branch/main/dist/timeline_viewer_v$Version.pyzw)
...
Download the latest release [timeline_viewer_v$Version.pyzw](https://codeberg.org/peter88213/timeline-view-tk/raw/branch/main/dist/timeline_viewer_v$Version.pyzw) ($PyzSize)

- Launch *timeline_viewer_v$Version.pyzw* by double-clicking (Windows desktop),
- or execute `python timeline_viewer_v$Version.pyzw` (Windows), resp. `python3 timeline_viewer_v$Version.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [timeline_viewer_v$Version.zip](https://codeberg.org/peter88213/timeline-view-tk/raw/branch/main/dist/timeline_viewer_v$Version.zip) ($ZipSize)

- Extract the *timeline_viewer_v$Version* folder from the downloaded zipfile "timeline_viewer_v$Version.zip".
