"""Provide a class for timeline-view-tk application and plugin package building. 
...
download_link = https://codeberg.org/peter88213/{self.PRJ_NAME}/raw/branch/main/dist/{self.PRJ_NAME}_v{self.version}.pyzw
'''
